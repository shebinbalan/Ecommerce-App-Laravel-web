...
if ($product) {
    ...
    else 
    {
        ...
        return view('frontend.reviews.index', compact('product', 'veryfied_purchase'));
    }
}  
        else
        {
    ...
    public function update(Request $request )
    {
       ...
       if($user_review != '')
       {
        ...
        if($review)
        {
            ...
            $review->update();
            return redirect('category/'.$review->products->category->slug.'/'.$review->products->slug)->with('status','Review updated Successfully');
        }
        else
       {
           return redirect()->back()->with('status',"The link you followed was broken");
